...
const updateAdmin = document.getElementById('update_admin');
updateAdmin.addEventListener('submit', function (event) {
  if (!validateName() || !validateEmail() || !validateOldPassword() || !validatePassword() || !validateConfirmPassword()) {
