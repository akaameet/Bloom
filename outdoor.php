...
include('dbconn.php');
//total user
$stmt = $pdo->prepare('SELECT * FROM product WHERE categories = "Outdoor plants" ORDER BY timestamp DESC');
$stmt->execute();
        ...
        <section class="product">
            <div class="product-list">
                ...
                <li><a href="indoor.php">
                        ...
                        <li ><a href="outdoor.php" style="background-color: red;" class="current">
